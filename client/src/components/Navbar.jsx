...
const Navbar = () => {
  ...
  return (
    ...
    <nav
      ref={sidebarRef}
      className={clsx(
        "hidden md:flex sticky top-0 h-screen border-r border-soft-border bg-surface z-50 flex-col justify-between py-6 px-4 shadow-none transition-all duration-300 shrink-0",
